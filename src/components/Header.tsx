...
import avatarImage from '@/images/photos/christian-headshot.jpeg'
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        <NavItem href="/cv" isActive={pathname === '/cv'}>CV</NavItem>
        <NavItem href="/articles" isActive={pathname === '/articles'}>Articles</NavItem>
        <NavItem href="/projects" isActive={pathname === '/projects'}>Projects</NavItem>
        <NavItem href="/about" isActive={pathname === '/about'}>About</NavItem>
        <NavItem href="/uses" isActive={pathname === '/uses'}>Uses</NavItem>
      </ul>
    </nav>
  )
}
...
function AvatarContainer({
  ...
  return (
    <div
      className={clsx(
        className,
        'h-10 w-10 rounded-xl bg-white/90 p-0.5 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:ring-white/10',
      )}
      {...props}
    />
  )
  ...
  return (
    ...
    >
      <Image
        ...
        className={clsx(
          'rounded-xl bg-zinc-100 object-cover object-top dark:bg-zinc-800',
